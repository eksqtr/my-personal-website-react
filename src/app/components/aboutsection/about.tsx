...
export const AboutSection = (prop: AboutProp) => {
    return (
        <section ref={prop.sectionRef} className="sm:mt-40 px-6 flex justify-center items-center flex-col lg:flex-row lg:h-screen py-20 lg:py-0" id="about">
            {/* Left Side */}
            <div className="lg:pt-20 lg:pr-16 sm:pt-10 text-center lg:text-left">
                ...
                <p className="text-md py-4 leading-7 lg:leading-8 text-gray-800 dark:text-gray-400">
                    ...
                    My core expertise lies in backend development, where I have strong development skills in server-side logic, API design & functionalities, and database architecture.
                ...
                <p className="text-xl text-gray-800 dark:text-gray-400">Let's Collaborate!</p>
